...
// parent.innerHTML += `<td>${stdObj.id}</td>`;
// parent.innerHTML += `<td>${stdObj.name}</td>`;
// parent.innerHTML += `<td>${stdObj.age}</td>`;
// parent.innerHTML += `<td>${stdObj.email}</td>`;
// parent.innerHTML += `<td>${stdObj.course}</td>`;
